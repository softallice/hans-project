...
<template>
  <div style="max-width: 800px; width: 100%;">
    ...
    <q-btn class="full-width absolute-bottom" label="저장하기" style="max-width: 800px; width: 100%;" @click="saveWeight" type="button" color="primary"/>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    async saveWeight() {
      ...
      let data = {
        ...
        wt: this.weight_data.wt,
        text: this.weight_data.text
      }
